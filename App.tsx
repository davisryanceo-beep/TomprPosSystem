...
export const STAMP_ONLY = import.meta.env.VITE_STAMP_ONLY === 'true' || window.location.hostname.includes('stamp.flowspos.com') || window.location.hostname.includes('tompr-stamp');
